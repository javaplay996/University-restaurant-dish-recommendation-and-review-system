...
public class CaipindingdanEntity<T> implements Serializable {
	 ...
	 * 设置：就餐方式
	 */
	public void setJiucanfangshi(String jiucanfangshi) {
		this.jiucanfangshi = jiucanfangshi;
	}
	/**
	 * 获取：就餐方式
	 */
	public String getJiucanfangshi() {
		return jiucanfangshi;
	}
	/**
	 * 设置：用户名
	 */
