<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="就餐方式" prop="jiucanfangshi">
          <el-select v-model="ruleForm.jiucanfangshi" placeholder="请选择就餐方式">
            <el-option
                v-for="(item,index) in jiucanfangshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="就餐方式" prop="jiucanfangshi">
	      <el-input v-model="ruleForm.jiucanfangshi"
                placeholder="就餐方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiadanshijian = true;
          ...
          if(o=='jiucanfangshi'){
            this.ruleForm.jiucanfangshi = obj[o];
	    this.ro.jiucanfangshi = true;
            continue;
          }
          if(o=='yonghuming'){
      ...
      this.$http({
		...
		if(json.lianxidianhua!=''&&json.lianxidianhua){
          ...
          this.$message.error(data.msg);
            ...
            this.jiucanfangshiOptions = "堂食,打包".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
